...
// Creates all time blocks and insert saved localStorage data
...
// analyze the time block to determine whether past, present or future
var checkTime = function () {
    currentTime = moment().format("hh:mm:ss");
    // $("#currentDay").text(currentTime);

    // set color for hour 9 and repeat 'if else' statements through hour 17
...
// Delete functions for each time block
...
// save functions for each time block
